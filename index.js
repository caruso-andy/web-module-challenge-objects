...
// function createMenuItem(name, cost, category, discount){
...
/* Task 5: Add a new rating with your (fictitious) opinions of the restaurant in the same format as the reviews above. */
  ...
  reviews.push({name: "Andy", rating: 5, feedback: "The karaoke was atrocious.  Will be back."});
  console.log(reviews);
...
and should return a string in the format `{name} gave the restaurant a {rating} star review, and their feedback was: {feedback}`
 * 
